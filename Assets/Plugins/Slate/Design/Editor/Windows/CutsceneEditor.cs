...
#pragma warning restore
            ...
            if ( e.type == EventType.KeyDown && GUIUtility.keyboardControl == 0 ) {
                ...
                if ( e.keyCode == KeyCode.S ) {
                    ...
                    if ( clip != null ) {
                        ...
                        if ( wrapper != null ) { wrapper.Split(cutscene.currentTime); }
                    }
                    e.Use();
                }
        ...
        void ShowWelcome() {
            ...
            var label = string.Format("<size=30><b>{0}</b></size>", isHelpButtonPressed ? "Important and Helpful Links" : "Welcome to SLATE!");
            var size = new GUIStyle("label").CalcSize(new GUIContent(label));
