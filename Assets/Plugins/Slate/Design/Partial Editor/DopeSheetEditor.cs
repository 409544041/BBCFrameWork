...
namespace Slate
{
 ...
 new Dictionary<IAnimatableData, DopeSheetRenderer>();
        public static void DrawDopeSheet(IAnimatableData animatable, IKeyable keyable, Rect rect, float startTime, float length, bool highlightRange
 = true) {
                ...
                if ( highlightRange && currentTimes.Count > 0 ) {
                    ...
                    if ( Mathf.Abs(firstKeyPos - lastKeyPos) > 0 ) {
                        ...
                        if ( rangeRect.width > 5 ) {
                            GUI.color =
 EditorGUIUtility.isProSkin ? new Color(0f, 0.5f, 0.5f, 0.4f) : new Color(1, 1, 1, 0.5f);
                ...
                for ( var t = 0; t < currentTimes.Count; t++ ) {
                    ...
                    var isSelected =
 t == pickIndex || ( rectSelectedIndeces != null && rectSelectedIndeces.Contains(t) );
                    ...
                    if ( Prefs.showDopesheetKeyValues ) {
                        ...
                        var valueLabelRect =
 Rect.MinMaxRect(dopeKeyRect.xMax, rect.yMin - 3, nextPos - dopeKeyRect.width / 2, rect.yMax);
                ...
                if ( pickIndex == -1 ) {
                    ...
                    var retimeInRect =
 Rect.MinMaxRect(pixelSelectionRect.xMin, pixelSelectionRect.yMin, pixelSelectionRect.xMin + 4, pixelSelectionRect.yMax);
                    var retimeOutRect =
 Rect.MinMaxRect(pixelSelectionRect.xMax - 4, pixelSelectionRect.yMin, pixelSelectionRect.xMax, pixelSelectionRect.yMax);
                    ...
                    if ( e.type == EventType.MouseDown && rect.Contains(e.mousePosition) ) {
                        ...
                        if ( timeSelectionRect == null ) {
                            ...
                            if ( pixelSelectionRect.Contains(e.mousePosition) ) {
                                ...
                                isRetiming =
 e.button == 0 && retimeInRect.Contains(e.mousePosition) || retimeOutRect.Contains(e.mousePosition);
                                e.Use();
                    ...
                    if ( eventType == EventType.MouseDrag && selectionStartPos != null ) {
                        ...
                        timeSelectionRect =
 Mathf.Abs(a - b) >= 0.001f ? Rect.MinMaxRect(xMin, rect.yMin, xMax, rect.yMax) : (Rect?)null;
                    }
                    ...
                    if ( eventType == EventType.MouseDrag && timeSelectionRect != null && e.button == 0 && ( startDragTime != null || isRetiming ) ) {
                        ...
                        if ( isRetiming ) {
                            ...
                            foreach ( var index in rectSelectedIndeces ) {
                                ...
                                var norm =
 Mathf.InverseLerp(preScaleSelectionRect.xMin, preScaleSelectionRect.xMax, preTime);
            ...
            void DoSingleKeyContextMenu(Event e, float time, TangentMode tangentMode) {
                ...
                menu.AddItem(new GUIContent("Jump Here (Double Click)"), false, () => { keyable.root.currentTime =
 time + keyable.startTime; });
