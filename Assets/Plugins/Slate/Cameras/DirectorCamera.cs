...
namespace Slate
{
    ...
    {
        [SerializeField] [HideInInspector] private bool _matchMainWhenActive = true;
        [SerializeField] [HideInInspector] private bool _setMainWhenActive = true;
        [SerializeField] [HideInInspector] private bool _autoHandleActiveState = true;
        [SerializeField] [HideInInspector] private bool _ignoreFOVChanges = false;
        [SerializeField] [HideInInspector] private bool _dontDestroyOnLoad = false;
#if SLATE_USE_POSTSTACK
        [SerializeField]
        [HideInInspector]
        ...
        public static DirectorCamera current
        {
            get
            {
                ...
                _current.cam.orthographic = true;
                var gameManager = GameObject.Find("GameManager");
                if (gameManager)
                {
                    _current.transform.SetParent(gameManager.transform);
                }
