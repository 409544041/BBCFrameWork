...
namespace Slate
{
    ...
    public class Cutscene : MonoBehaviour, IDirector
    {
        ...
        [SerializeField, HideInInspector] public List<CutsceneGroup> groups = new List<CutsceneGroup>(); //非全局组
        [SerializeField, HideInInspector] private float _length = 20f;
        [SerializeField, HideInInspector] private float _viewTimeMin = 0f;
        [SerializeField, HideInInspector] private float _viewTimeMax = 21f;

        [System.NonSerialized] private float _currentTime;
        [System.NonSerialized] private float _playTimeMin;
        [System.NonSerialized] private float _playTimeMax;
        [System.NonSerialized] private Transform _groupsRoot;
        [System.NonSerialized] private List<IDirectableTimePointer> timePointers;
        [System.NonSerialized] private List<IDirectableTimePointer> unsortedStartTimePointers;
        [System.NonSerialized] private Dictionary<GameObject, bool> affectedLayerGOStates;

        [System.NonSerialized]
        private static readonly Dictionary<string, Cutscene> AllSceneCutscenes = new Dictionary<string, Cutscene>();

        [System.NonSerialized] private bool preInitialized;
        [System.NonSerialized] private bool _isReSampleFrame;
        ...
        ///The groups
        IEnumerable<IDirectable> IDirector.children
        {
            get { return groups.Cast<IDirectable>(); }
        }
        ...
        public void Play(float startTime, System.Action callback)
        {
        ...
        public void SkipCurrentSection()
        {
            ...
            var section = forward
                ? directorGroup.GetSectionAfter(currentTime)
                : directorGroup.GetSectionBefore(currentTime);
        ...
        {
            return PlayFromSection(GetSectionByName(name), wrap, callback);
        }

        public bool PlayFromSection(Section section)
        {
            return PlayFromSection(section, defaultWrapMode);
        }
        ...
        */
        ...
        {
            if (groupsRoot.transform.parent != this.transform)
            {
                groupsRoot.transform.parent = this.transform;
            }
        ...
        void ShowTransforms()
        {
            ...
            groupsRoot.hideFlags = HideFlags.None;
        }
        ...
        void HideTransforms()
        {
            ...
            groupsRoot.hideFlags = HideFlags.HideInHierarchy;
        }
        ...
        public T AddGroup<T>(GameObject targetActor = null) where T : CutsceneGroup
        {
            return (T)AddGroup(typeof(T), targetActor);
        }
