...
namespace Slate
{
    ...
    abstract public class CutsceneTrack : MonoBehaviour, IDirectable
    {
        ...
        [SerializeField] [HideInInspector] private List<ActionClip> _actionClips = new List<ActionClip>();
        ...
        {
            foreach (var actionClip in _actionClips)
            {
                actionClip.OnInterrupted();
            }
        }
#if UNITY_EDITOR
        //Gizmos selected
        ...
        {
            if (selected) OnDrawGizmosSelected();
        }
 ...
 type.GetCustomAttributes(typeof(CategoryAttribute), true).FirstOrDefault() as CategoryAttribute;
        ...
        [SerializeField] [HideInInspector] private float _customHeight = 300f;
        ...
        protected void DoDefaultInfoGUI(Event e, Rect trackRect)
        {
            ...
            if (icon != null)
            {
                ...
                GUI.color = ReferenceEquals(CutsceneUtility.selectedObject, this)
                    ? Color.white
        ...
        protected void DoParamsInfoGUI(Event e, Rect trackRect, IKeyable keyable, bool showAddPropertyButton)
        {
            ...
            if (keyable.animationData != null && keyable.animationData.animatedParameters != null)
            {
                ...
                for (var i = 0; i < paramsCount; i++)
                {
                    ...
                    GUI.color = inspectedParameterIndex == i
