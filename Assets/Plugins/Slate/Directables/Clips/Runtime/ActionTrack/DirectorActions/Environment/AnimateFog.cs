...
namespace Slate.ActionClips
{
    ...
    public class AnimateFog : DirectorActionClip
    {
        ...
        [SerializeField] [HideInInspector] private float _blendIn;
        [SerializeField] [HideInInspector] private float _blendOut;

        [AnimatableParameter] public Color fogColor;
        [AnimatableParameter] public float fogDensity;
        [AnimatableParameter] public float linearFogStartDistance;
        [AnimatableParameter] public float linearFogEndDistance;
