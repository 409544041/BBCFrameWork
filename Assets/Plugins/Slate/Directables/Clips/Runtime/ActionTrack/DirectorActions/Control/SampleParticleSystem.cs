...
namespace Slate.ActionClips
{
    ...
    public class SampleParticleSystem : DirectorActionClip
    {
        ...
        [Required] public ParticleSystem particles;

        [Tooltip(
            "If true, then particles simulation will be time synced with the cutscene, otherwise simulation will take place independently")]
