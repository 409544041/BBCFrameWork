...
namespace Slate.ActionClips
{
    ...
    {
        [SerializeField] [HideInInspector] private float _length = 4f;
        [SerializeField] [HideInInspector] private float _blendIn = 1f;
        [SerializeField] [HideInInspector] private float _blendOut = 1f;

        [AnimatableParameter(0, 1)] public float fade = 1;
        [AnimatableParameter("Color")] public Color outColor = Color.black;
