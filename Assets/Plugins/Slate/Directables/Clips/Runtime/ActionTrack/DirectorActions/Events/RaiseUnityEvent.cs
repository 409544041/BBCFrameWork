...
namespace Slate.ActionClips
{
    [Category("Events")]
    [Description(
        "Raise a Unity Event when the time is moving forwards and another when the time is moving backwards. This is helpfull if you want to use these events with UI to reverse their state, both in runtime and in editor.")]
