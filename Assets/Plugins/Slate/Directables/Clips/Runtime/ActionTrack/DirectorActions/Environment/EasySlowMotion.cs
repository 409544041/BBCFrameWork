...
namespace Slate.ActionClips
{
    ...
    {
        [SerializeField] [HideInInspector] private float _length = 1.2f;
        [SerializeField] [HideInInspector] private float _blendIn = 0.5f;
        [SerializeField] [HideInInspector] private float _blendOut = 0.5f;

        [Range(0.05f, 1)] public float timeScale = 0.1f;
