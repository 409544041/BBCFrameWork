...
namespace Rabi
{
    public static class UnityExtensions
    {
        ...
        public static GameObject Instantiate(this MonoBehaviour mono, GameObject prefab, bool show = true)
        {
        ...
        public static GameObject Instantiate(this MonoBehaviour mono, GameObject prefab, Transform parent,
            bool show = true)
        {
        ...
        public static GameObject Instantiate(this MonoBehaviour mono, GameObject prefab, Vector3 position,
            bool show = true)
        {
        ...
        public static GameObject Instantiate(this MonoBehaviour mono, GameObject prefab, Vector3 position,
            ...
            bool show = true)
        {
            GameObject go = UnityEngine.Object.Instantiate(prefab, position, Quaternion.identity, parent);
            go.SetActive(show);
            return go;
        }
    ...
    public static class TransformExtension
    {
        ...
        {
            component.transform.SetParent(parentComp == null ? null : parentComp.transform);
            return component;
        }
        ...
        public static T Position<T>(this T component, Vector3 pos) where T : Component
        {
            component.transform.position = pos;
            return component;
        }

        public static T Position<T>(this T component, float x, float y, float z) where T : Component
        {
            component.transform.position = new Vector3(x, y, z);
            return component;
        }

        public static T Position<T>(this T component, float x, float y) where T : Component
        {
        ...
        public static T Position<T>(this T component, Func<Vector3, Vector3> Setter) where T : Component
        {
            component.transform.position = Setter(component.transform.position);
            return component;
        }
